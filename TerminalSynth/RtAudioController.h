...
public:
	...
	/// </summary>
	static OutputSettings* GetPlaybackParameters();
	...
	/// instance pointer!
	/// </summary>
	static OutputSettings* GetPlaybackParametersUnsafe()
	{
		if (RtAudioController::Parameters == nullptr)
			RtAudioController::Parameters = new OutputSettings("Not Initializied", "Not Initialized", "Not Initialized", 0, 0, 0);
...
protected:
	...
	static OutputSettings* Parameters;
