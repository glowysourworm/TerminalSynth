...
//	float GenerateStkVoiceSample(float frequency, float signalLow, float signalHigh, size_t timeCursor, double streamTime);
//
//private:
//
...
//	stk::VoicForm* _stkVoiceForm;
//	stk::Rhodey* _stkRhodey;
//	stk::BlowHole* _stkBlowHole;
