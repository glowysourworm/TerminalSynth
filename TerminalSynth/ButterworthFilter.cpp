...
ButterworthFilter::ButterworthFilter(int samplingRate, float gain) : SignalParameterizedBase("ButterworthFilter")
{
	this->history1 = 0.f;
	this->history2 = 0.f;
	this->history3 = 0.f;
	...
	this->AddParameter("Cutoff", this->min_cutoff, this->max_cutoff, 5000);		// Index 0
	this->AddParameter("Resonance", 0, 1, 0.5f);								// Index 1
}

ButterworthFilter::~ButterworthFilter()
{
	//SignalParameterizedBase::~SignalParameterizedBase();
}
