...
namespace TerminalSynth
{
	...
	// a better hashing function. I'm going to use boost in the future for some of this rebuilding the wheel). The
	// result will be on the seed value.
	static void HashCombine(size_t& seed, size_t& nextHash)
	{
